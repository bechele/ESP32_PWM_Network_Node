/* Firmware to read broadcasts on port 7625 from the network and output the 
   data as servo or relais movements. Intended to be used with 
   bechele software. https://bechele.de
